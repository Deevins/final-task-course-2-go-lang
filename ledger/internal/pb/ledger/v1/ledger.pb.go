...
type Report struct {
	...
	TotalExpense  float64                `protobuf:"fixed64,6,opt,name=total_expense,json=totalExpense,proto3" json:"total_expense,omitempty"`
...
const file_ledger_v1_ledger_proto_rawDesc = "" +
	...
	"\x06period\x18\x05 \x01(\tR\x06period\x129\n" +
	"\n" +
	...
	"\ftotal_income\x18\x05 \x01(\x01R\vtotalIncome\x12#\n" +
	"\rtotal_expense\x18\x06 \x01(\x01R\ftotalExpense\x12\x1a\n" +
	"\bcurrency\x18\a \x01(\tR\bcurrency\"T\n" +
